...
import { GameState, GameConfig, GameResult, Pokemon, GameMode, GameDifficulty, Achievement } from '@/types'
...
export const useGameTimer = () => {
  const { timeRemaining, isGameActive, setTimeRemaining, endGame } = useGameStore()
